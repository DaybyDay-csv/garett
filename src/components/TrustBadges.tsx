...
export const TrustBadges = ({
  ...
  const cardClasses = darkBackground 
    ? 'bg-header-foreground/10 border-header-foreground/20' 
    : 'bg-card border';
  const titleClasses = darkBackground ? 'text-header-foreground' : '';
  const descClasses = darkBackground ? 'text-header-foreground/70' : 'text-muted-foreground';
