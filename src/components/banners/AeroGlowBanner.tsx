        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8 items-center py-4 md:py-6 lg:py-8">
          ...
          <div className="text-center space-y-2 md:space-y-4 order-2 lg:order-1">
            ...
            <div className="space-y-2 px-2">
              ...
              <p className="text-sm md:text-base lg:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0 text-neutral-50">
                Transforma tu cabello con tecnología iónica profesional. <span className="font-semibold text-stone-50">
Resultados visibles desde el primer uso.</span>
            ...
            <div className="grid grid-cols-3 gap-2 px-2">
              <div className="p-2 md:p-3 rounded-xl bg-[#D4AF37]/10 border border-[#D4AF37]/30 hover:border-[#D4AF37] transition-all py-0">
                <Zap className="w-4 h-4 md:w-5 md:h-5 text-[#D4AF37] mb-1" />
                <div className="font-bold text-xs md:text-sm text-gray-50">Calor Uniforme</div>
                <div className="text-[11px] md:text-xs text-muted-foreground">Tecnología avanzada</div>
              </div>
              <div className="p-2 md:p-3 rounded-xl bg-[#8B6F47]/10 border border-[#8B6F47]/30 hover:border-[#8B6F47] transition-all py-0">
                <Shield className="w-4 h-4 md:w-5 md:h-5 text-[#8B6F47] mb-1" />
                <div className="font-bold text-xs md:text-sm text-gray-50">Protección Total</div>
                <div className="text-[11px] md:text-xs text-muted-foreground">Iones negativos</div>
              </div>
              <div className="p-2 md:p-3 rounded-xl bg-[#5D4037]/10 border border-[#5D4037]/30 hover:border-[#5D4037] transition-all py-0">
                <Award className="w-4 h-4 md:w-5 md:h-5 text-[#5D4037] mb-1" />
                <div className="font-bold text-xs md:text-sm text-gray-50">Made in Poland</div>
