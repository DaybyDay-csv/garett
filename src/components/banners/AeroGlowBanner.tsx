  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-[#5D4037]/5 via-background to-[#8B6F47]/5 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-12">
        {/* Main Hero Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 lg:gap-16 items-center py-8 md:py-12 lg:py-16">
          {/* Left Content */}
        ...
        <div className="pb-8 md:pb-12 lg:pb-16 border-t border-border/30 pt-8 md:pt-12">
          <div className="text-center mb-4 md:mb-8">
            <Badge className="mb-2 md:mb-4 bg-[#8B6F47]/20 text-[#5D4037] dark:text-[#D7B896] border border-[#8B6F47]/30 text-xs md:text-sm">
              RESULTADOS REALES
            </Badge>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-3 md:gap-6 max-w-5xl mx-auto">
            ...
            <div className="group relative">
              <div className="absolute -inset-1 bg-gradient-to-br from-gray-400 to-gray-600 rounded-xl md:rounded-2xl blur opacity-25 group-hover:opacity-40 transition" />
              <div className="relative bg-background rounded-xl md:rounded-2xl overflow-hidden shadow-xl border border-border">
                <div className="absolute top-2 left-2 md:top-4 md:left-4 z-10">
                  <Badge className="bg-gray-500 text-white text-[10px] md:text-xs px-2 py-0.5 md:px-3 md:py-1">ANTES</Badge>
                </div>
                <img 
                  src={hairBefore}
                ...
                />
                <div className="p-2 md:p-4 bg-gradient-to-t from-background to-transparent">
                  <p className="text-[10px] md:text-sm text-muted-foreground">Sin tratar</p>
                </div>
              </div>
            </div>
            ...
            {/* After */}
            <div className="group relative">
              <div className="absolute -inset-1 bg-gradient-to-br from-[#D4AF37] to-[#8B6F47] rounded-xl md:rounded-2xl blur opacity-50 group-hover:opacity-75 transition animate-pulse" />
              <div className="relative bg-background rounded-xl md:rounded-2xl overflow-hidden shadow-2xl border-2 border-[#D4AF37]">
                <div className="absolute top-2 left-2 md:top-4 md:left-4 z-10">
                  <Badge className="bg-gradient-to-r from-[#D4AF37] to-[#8B6F47] text-white text-[10px] md:text-xs px-2 py-0.5 md:px-3 md:py-1">DESPUÉS</Badge>
                </div>
                <img 
                  src={hairAfter}
                ...
                <div className="p-2 md:p-4 bg-gradient-to-t from-background to-transparent">
                  <div className="flex items-center gap-1 md:gap-2">
                    ...
                    <p className="text-[10px] md:text-sm font-semibold">Liso perfecto</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Final CTA */}
          <div className="text-center mt-4 md:mt-8 relative z-20 space-y-2 md:space-y-3">
            <Link 
              to={product ? `/producto/${product.node.handle}` : "#"}
              className="inline-flex items-center justify-center group text-sm md:text-base h-12 md:h-14 px-8 md:px-12 bg-gradient-to-r from-[#5D4037] to-[#8B6F47] hover:from-[#4A322B] hover:to-[#6E5738] shadow-2xl hover:shadow-3xl transition-all text-white rounded-md font-medium cursor-pointer relative z-20"
            >
              <span className="hidden md:inline">Consigue tu AeroGlow Ahora</span>
              <span className="md:hidden">Comprar AeroGlow</span>
