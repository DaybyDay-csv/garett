...
export const WhiteWeekBanner = () => {
  ...
  return (
    <div className="relative w-full min-h-[500px] md:min-h-[500px] bg-gradient-to-br from-promo-white via-background to-promo-white overflow-hidden">
      {/* Pattern overlay */}
      <div 
      ...
      <div className="container mx-auto px-6 md:px-8 min-h-full flex flex-col items-center justify-center text-center relative z-10 space-y-4 md:space-y-8 py-16 md:py-20 pb-20 md:pb-20 max-w-5xl">
        ...
        <div className="bg-card border border-border rounded-lg p-4 md:p-6 shadow-xl max-w-lg w-full space-y-2 md:space-y-4">
          <p className="text-xs md:text-sm text-muted-foreground">Código de descuento</p>
          <div className="flex items-center gap-3">
            <code className="flex-1 bg-secondary text-foreground text-lg md:text-2xl font-mono font-bold px-3 md:px-4 py-2 md:py-3 rounded whitespace-nowrap overflow-x-auto">
              {discountCode}
            </code>
            <Button
              size="icon"
