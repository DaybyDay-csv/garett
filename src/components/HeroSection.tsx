  ...
  return <section className="relative overflow-hidden min-h-[550px] md:min-h-[700px]">
      ...
      <div className="container relative py-6 md:py-20 h-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start md:items-center h-full">
          ...
          <div className="space-y-3 md:space-y-6 text-left max-w-[280px] md:max-w-xl">
            ...
            <div className="flex flex-col gap-2.5 md:gap-4 w-64 md:max-w-none animate-fade-in [animation-delay:200ms]">
              <Button asChild size="lg" className="text-sm md:text-base group bg-header hover:bg-header/90 text-header-foreground h-10 md:h-11 px-6 w-full">
                <Link to="/novedades">
                  Ver Novedades
              ...
              <Button asChild variant="outline" size="lg" className="text-sm md:text-base border-header text-header hover:bg-header/5 h-10 md:h-11 px-6 w-full">
                <Link to="/superventas">
                  Ver Superventas
                </Link>
              </Button>
