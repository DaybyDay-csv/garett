  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="container py-12 -mt-8">
        ...
        {loading ? <div className="py-20 text-center">
          ...
          </div> : <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
            {products.map(product => <ProductCard key={product.node.id} product={product} hideBadges={true} hideAddToCart={true} />)}
          </div>}
